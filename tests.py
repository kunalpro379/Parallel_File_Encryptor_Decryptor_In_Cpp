...
def makeFiles(path, num_files=10):  # Create 1000 test files
...
if __name__ == "__main__":
    makeFiles("C:/Users/kunal/OneDrive/CODE FOR LIFE/BuildFromScratch/Parallel_File_Encryptor_Decryptor/test1")
    makeFiles("C:/Users/kunal/OneDrive/CODE FOR LIFE/BuildFromScratch/Parallel_File_Encryptor_Decryptor/test2")